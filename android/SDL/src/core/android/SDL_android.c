...
#define SDL_JAVA_PREFIX                               github_pasticho8080_acgc
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved)
{
    ...
    register_methods(env, "github/pasticho8080/acgc/SDLActivity", SDLActivity_tab, SDL_arraysize(SDLActivity_tab));
    register_methods(env, "github/pasticho8080/acgc/SDLInputConnection", SDLInputConnection_tab, SDL_arraysize(SDLInputConnection_tab));
    register_methods(env, "github/pasticho8080/acgc/SDLAudioManager", SDLAudioManager_tab, SDL_arraysize(SDLAudioManager_tab));
    register_methods(env, "github/pasticho8080/acgc/SDLControllerManager", SDLControllerManager_tab, SDL_arraysize(SDLControllerManager_tab));
