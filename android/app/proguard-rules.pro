...
-keep,includedescriptorclasses,allowoptimization class github.pasticho8080.acgc.SDLInputConnection {
    void nativeCommitText(java.lang.String, int);
    void nativeGenerateScancodeForUnichar(char);
}

-keep,includedescriptorclasses class github.pasticho8080.acgc.SDLActivity {
    # for some reason these aren't compatible with allowoptimization modifier
    boolean supportsRelativeMouse();
    void setWindowStyle(boolean);
}

-keep,includedescriptorclasses,allowoptimization class github.pasticho8080.acgc.SDLActivity {
...
-keep,includedescriptorclasses,allowoptimization class github.pasticho8080.acgc.HIDDeviceManager {
...
-keep,includedescriptorclasses,allowoptimization class github.pasticho8080.acgc.SDLAudioManager {
...
-keep,includedescriptorclasses,allowoptimization class github.pasticho8080.acgc.SDLControllerManager {
